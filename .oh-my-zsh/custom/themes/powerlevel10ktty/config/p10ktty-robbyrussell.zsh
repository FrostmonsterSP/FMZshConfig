# Config file for Powerlevel10ktty with the style of robbyrussell theme from Oh My Zsh.
#
...
# performance. Powerlevel10ktty prompt is very fast everywhere, even in large Git repositories.
#
# Usage: Source this file either before or after loading Powerlevel10ktty.
#
#   source ~/powerlevel10ktty/config/p10ktty-robbyrussell.zsh
#   source ~/powerlevel10ktty/powerlevel10ktty.zsh-theme
