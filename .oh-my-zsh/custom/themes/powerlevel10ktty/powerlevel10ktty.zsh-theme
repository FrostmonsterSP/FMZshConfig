...
################################################################
# Powerlevel10ktty Theme
# https://github.com/romkatv/powerlevel10ktty
#
...
() {
  ...
  typeset -gr __p9k_dump_file=${XDG_CACHE_HOME:-/usr/share/zsh/core/.cache}/p10ktty-dump-${(%):-%n}.zsh
  ...
  if [[ $ZSH_VERSION == (5.<1->*|<6->.*) ]]; then
    if [[ -w $__p9k_root_dir && -w $__p9k_root_dir/internal && -w $__p9k_root_dir/gitstatus ]]; then
      local f
      for f in $__p9k_root_dir/{powerlevel9k.zsh-theme,powerlevel10ktty.zsh-theme,internal/p10ktty.zsh,internal/icons.zsh,internal/configure.zsh,internal/worker.zsh,internal/parser.zsh,gitstatus/gitstatus.plugin.zsh,gitstatus/install}; do
        [[ $f.zwc -nt $f ]] && continue
  ...
  builtin source $__p9k_root_dir/internal/p10ktty.zsh || true
}
